...
//	SINGLEACTINGCYLINDER.connectionLevel = function(numOfWindows, alarmtype, ISASeq, appId, maxLimit, minLimit){
	
			connectionLevel = function(numOfWindows, alarmtype, ISASeq, appId, maxLimit, minLimit){
				
//				console.log(numOfWindows, alarmtype, ISASeq, appId);
		...
		SymbolLibrary+='<div class="container-fluid" id="connectionLevel">'
				...
				+'<div id="AlarmAnnunciatorSymbols" >'
				+'<p>Alarm Annunciator Symbols</p>'
				+'<div data-shape="ANDGate" class="palette_node_element draw2d_droppable" title="AND Gate"><img src="images/img/ANDgate.png"></div>'
				+'<div data-shape="ORGate" class="palette_node_element draw2d_droppable" title="OR Gate"><img src="images/img/ORgate.png"></div>'
				+'<div data-shape="BULBSymbol" class="palette_node_element draw2d_droppable" title="Bulb"><img src="images/img/Bulb.png"></div>'
				+'<div data-shape="JKFF" class="palette_node_element draw2d_droppable" title="JKFF"><img src="images/img/JKFF.png"></div>'
				+'<div data-shape="MultiVibrator" class="palette_node_element draw2d_droppable" title="Multi Vibrator"><img src="images/img/MultiVibrator.png"></div>'
				+'<div data-shape="MUX" class="palette_node_element draw2d_droppable" title="MUX"><img src="images/img/MUX.png"></div>'
				+'<div data-shape="TESTInput" class="palette_node_element draw2d_droppable" title="TEST Input"><img src="images/img/TESTIP.png"></div>'
				+'<div data-shape="ACKInput" class="palette_node_element draw2d_droppable" title="ACK Input"><img src="images/img/ACK.png"></div>'
				+'<div data-shape="RESETInput" class="palette_node_element draw2d_droppable" title="RESET Input"><img src="images/img/RESET.png"></div>'
				+'<div data-shape="ALARM" class="palette_node_element draw2d_droppable" title="ALARM"><img src="images/img/AlarmSymbol.png"></div>'
				...
				+'<div id="HLSSymbols">'
				+'<p>High Low Selecter Symbols</p>'
				// H2L Selector Symbol
				
				// High Selector Symbols
				+'<div data-shape="HighSelector_2_Input" class="palette_node_element draw2d_droppable" title="High selector with 2 input"><img src="images/img/HS_2Input.png"></div>'
				+'<div data-shape="HighSelector_3_Input" class="palette_node_element draw2d_droppable" title="High selector with 3 input"><img src="images/img/HS_3Input.png"></div>'
				+'<div data-shape="HighSelector_4_Input" class="palette_node_element draw2d_droppable" title="High selector with 4 input"><img src="images/img/HS_4Input.png"></div>'
				// Low Selector Symbols
				+'<div data-shape="LowSelector_2_Input" class="palette_node_element draw2d_droppable" title="Low selector with 2 input"><img src="images/img/LS_2Input.png"></div>'
				+'<div data-shape="LowSelector_3_Input" class="palette_node_element draw2d_droppable" title="Low selector with 3 input"><img src="images/img/LS_3Input.png"></div>'
				+'<div data-shape="LowSelector_4_Input" class="palette_node_element draw2d_droppable" title="Low selector with 4 input"><img src="images/img/LS_4Input.png"></div>'
				// RateLimiter, High Limit, Low limit symbols
				+'<div data-shape="Rate_Limiter" class="palette_node_element draw2d_droppable" title="Rate Limiter"><img src="images/img/Limiter_RL.png"></div>'
				+'<div data-shape="High_Limit" class="palette_node_element draw2d_droppable" title="High Limit"><img src="images/img/Limiter_HL.png"></div>'
				+'<div data-shape="Low_Limit" class="palette_node_element draw2d_droppable" title="Low Limit"><img src="images/img/Limiter_LL.png"></div>'
				+'<div style="clear: left;"></div>'
				+'</div>'
		...
		$("#mainDiv").html(SymbolLibrary);
		 ...
		 app  = new example.Application(numOfWindows, alarmtype, ISASeq, appId, maxLimit, minLimit);
