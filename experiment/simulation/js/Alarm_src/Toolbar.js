...
example.Toolbar = Class.extend({
	...
	init:function(elementId, view, numOfWindows, alarmtype, ISASeq, appId, maxLimit, minLimit){
		this.html = $("#"+elementId);
		this.view = view;
...
//			 console.log(jsonarray);
				checkConnectionsForAlarmAnnunciator(numOfWindows, alarmtype, ISASeq,jsonarray, appId);
...
//			}
        ...
        this.hintButton.button().click(function(){
			ConnHint(numOfWindows, alarmtype, ISASeq, appId);
			});
...
//			console.log(jsonarray);
        	if(rightConn != 0 ){
					...
					if ((appId == "1" &&  ISASeq == "1") || (appId == "1" &&  ISASeq == "2") || (appId == "1" &&  ISASeq == "3")) {
		
						LCS_Characterisation2A2B(numOfWindows, alarmtype, ISASeq, appId, maxLimit, minLimit);
		
					}
					if ((appId == "2" &&  ISASeq == "1") || (appId == "2" &&  ISASeq == "2") || (appId == "2" &&  ISASeq == "3")) {
						
						TCS_Characterisation2A2B(numOfWindows, alarmtype, ISASeq, appId, maxLimit, minLimit);
		
					}
					if ((appId == "3" &&  ISASeq == "1") || (appId == "3" &&  ISASeq == "2") || (appId == "3" &&  ISASeq == "3")) {
						
						PCS_Characterisation2A2B(numOfWindows, alarmtype, ISASeq, appId, maxLimit, minLimit);
		
					}
					if ((appId == "4" &&  ISASeq == "1") || (appId == "4" &&  ISASeq == "2") || (appId == "4" &&  ISASeq == "3")) {
						
						FCS_Characterisation2A2B(numOfWindows, alarmtype, ISASeq, appId, maxLimit, minLimit);
