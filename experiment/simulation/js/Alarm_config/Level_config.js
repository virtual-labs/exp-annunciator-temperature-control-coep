...
Level_config = function(appId){
		...
		selectApp +='<div id = "LCSConfigDiv" class="container-fluid">'
		    ...
		    +'<h1>Level Control System</h1>'
				...
				+'<select class="form-control" name="App" id="LCS_MinMaxLimit" >'
				...
				+'</select>'
				+'<button id="LCSConfigNext">Next</button>'
...
//		var maxLimit = 70;
//		var minLimit = 30;
		 var minLimit = $("#LCS_MinMaxLimit").find(':selected').data('lowerspan');
		 var maxLimit =  $("#LCS_MinMaxLimit").find(':selected').data('higherspan');
